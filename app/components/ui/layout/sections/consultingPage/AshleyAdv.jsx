export default function AshleyAdv() {
  return (
    <div className="w-[100vw] xs:h-auto md:h-[102vh] pt-20">
      <h2
        className="xs:text-2xl xs:mb-1 md:text-4xl font-bold text-white text-center mb-5
      xs4:text-3xl
      "
      >
      ...
      <div className="flex flex-col gap-5">
        <div>
          <div className="flex flex-col xs:gap-1 md:gap-4  xs:w-[95%] md:w-[90%] mx-auto p-4  white-glassmorphism text-white">
            ...
            <p className="text-[#B0C7EF] xs:text-sm md:text-lg xs5:text-base">
              ...
              clients individual needs and aspirations in order to create real
              and tangible value.
            </p>
          </div>
        </div>
        ...
        <div>
          <div className="flex flex-col xs:gap-1 md:gap-4  xs:w-[95%] md:w-[90%] mx-auto p-4  white-glassmorphism text-white">
            ...
            <p className="text-[#B0C7EF] xs:text-sm md:text-lg xs5:text-base">
              ...
              within the DeFi sector that offer the most optimal returns in
              order to help ensure our clients' financial success.
            </p>
          </div>
        </div>
        <div></div>
