...
export default function Vaults() {
  ...
  async function handleSonicDeposit(event) {
    ...
    try {
      //If checkbox checked ==> depositSonicRef(true) is called. Otherwise depositSonic() is called
      // 1) Call the depositSonic function on your Vault contract
      let tx;
      const depositValue = ethers.parseEther(sonicDeposit);
      if (isReferred) {
        tx = await contract.depositSonicRef(true, {
          value: depositValue,
        });
      } else {
        tx = await contract.depositSonic({
          value: depositValue,
        });
      }
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-[#292941] xs:w-[95%] md:w-[80vw] lg:w-[50vw] mx-auto min-h-[20vh] rounded-2xl mb-16 pb-8">
          ...
          >
            ...
            {/* [CHANGE] Add a checkbox for referral */}
            <div className="flex items-center justify-center gap-2">
              ...
              <label htmlFor="referralCheckbox">
                I was referred by Graham Plumb.
              </label>
            </div>
