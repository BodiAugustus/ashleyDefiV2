...
export default function Layout({ children }) {
  ...
  return (
    <div>
      <nav className="w-full h-[12vh] px-4 flex items-center navbar justify-between max-w-[2200px] text-white">
        <div className="flex items-center justify-between xs:w-[100%] md:w-[7%] ">
          <Link href="/">
            <Image
        ...
        <ul
          className={`hidden md:flex md:justify-between gap-10 text-2xl font-sans font-thin `}
        >
          {/* Navigation Links */}
          <li>
            <Link
